...
const enviarCorreo = () => {
  ...
  emailjs
    .send("service_kw3llud", "template_fczj1v6", templateParams)
    .then((response) => {
      console.log(
...
<template>
  <footer class="bg-white" id="paquetes">
    <div
    ...
    >
      <div class="text-center">
        ...
        <p class="mx-auto mt-4 max-w-xl text-gray-500">
          Estamos especializados en adaptar nuestras soluciones a tus
          necesidades específicas. La sección "Personaliza Tu Experiencia" está
          diseñada para ofrecerte un nivel único de flexibilidad y adaptabilidad
          en nuestras soluciones tecnológicas. Descubre cómo puedes dar forma a
          tu experiencia con nosotros y obtener herramientas que se ajusten
          perfectamente a tu visión y objetivos.
        </p>
